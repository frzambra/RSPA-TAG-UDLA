...
## Contenido gravimétrico de agua (θg) {.center .smaller}
...
## Ejemplo: cálculo de θg paso a paso {.center .smaller}
...
::: {.notes}
1. θg = (96−80)/80 = 0.20 g/g. 2. 16 g de agua. 3. 20%.
:::
...
::: {.notes}
Arenoso: θv = 0.12 × 1.60 = 0.192 → L = 0.192 × 500 mm = 96 mm. Franco: θv = 0.25 × 1.35 = 0.338 → L = 0.338 × 700 = 236 mm. Arcilloso: θv = 0.38 × 1.10 = 0.418 → L = 0.418 × 600 = 251 mm. 3. El arcilloso tiene más agua total, aunque con perfiles de distinta profundidad; el franco queda cerca porque su perfil es más profundo.
:::
...
## Saturación (S): el punto de partida {.center .smaller}
...
## Drenaje interno: de Saturación a CC {.center .smaller}
...
## Capacidad de Campo (CC) {.center .smaller}
...
## ¿CC es realmente -33 kPa para todos los suelos? {.center .smaller}
...
|---------|--------------------------|-----------|
| Arenoso | ≈ -10 kPa | Sus poros grandes drenan rápido — a -33 kPa ya está más seco de lo que realmente queda en campo |
| Franco | **-33 kPa** | El estándar original — buena aproximación |
| Arcilloso | -33 kPa (o menor) | Drena lento, pero retiene el agua con mucha fuerza en microporos — -33 kPa es una aproximación razonable |

**Convención del curso:** Usamos **-33 kPa como CC estándar** para todos los suelos, reconociendo que es una aproximación (en suelos arenosos algunos autores usan -10 kPa). Es el estándar agronómico internacional.
:::

---

## Punto de Marchitez Permanente (PMP) {.center .smaller}
...
## Valores típicos de PMP por textura {.center .smaller}
...
## Las tres categorías de agua en el suelo {.center .smaller}
...
::: {.notes}
1. Agua gravitacional, no disponible (drena). 2. Agua disponible (ADT = 0.19). 3. Agua no disponible (adsorbida fuertemente).
:::

---

## Ejemplo: cálculo de CC, PMP y ADT desde la curva {.center .smaller}
...
![](../../images/curva_retencion_suelo_ejemplo.png){fig-align="center"}

---

## Ejercicio integrador {.center .smaller}
...
::: {.notes}
1. ADT: Ap = 0.19; Bt = 0.11; C = 0.10 cm³/cm³. 2. Láminas: Ap = 0.19 × 250 = 47.5 mm; Bt = 0.11 × 300 = 33 mm; C = 0.10 × 350 = 35 mm. 3. Total = 115.5 mm. 4. 115.5 / 5.5 = 21 días desde CC hasta PMP (sin considerar AFA, que se ve en la sesión 2.4). La Da no se necesita porque CC y PMP ya están en base volumétrica.
:::
...
7. ¿Por qué el estándar de secado para determinar θg es 105°C? ¿En qué suelos se usa una temperatura menor y por qué?

...
## ¿Por qué importan estas relaciones? {.center .smaller}
...
![](../../images/agua_en_el_suelo.png){fig-align="center"}
...
**Procedimiento paso a paso: [Video](https://www.youtube.com/watch?v=pOQcfaw7UEk)**
...
## Errores comunes en la medición de Da {.center .smaller}
...
## Valores típicos e interpretación de Da {.center .smaller}
...
## Densidad real (Dr): definición y valores {.center .smaller}
...
## Método del picnómetro para Dr {.center .smaller}
...
## Porosidad total (P) {.center .smaller}
...
## Ejemplo completo de cálculo {.center .smaller} 
...
## Aplicación práctica: ¿cuánta agua cabe en este suelo? {.center .smaller}
...
## Relación entre Da, Dr y P: tabla resumen {.center .smaller}
...
::: {.notes}
1. Da = 142 / 100 = 1.42 g/cm³. 2. Vs = 142 / 2.65 = 53.6 cm³. 3. Vp = 100 − 53.6 = 46.4 cm³. 4. P = 46.4% (= (1 − 1.42/2.65) × 100). 5. No: para un franco, 1.3–1.5 es el rango ideal y la Da crítica (~1.6) no se alcanza.
:::
...
::: {.notes}
1. P = (1 − Da/Dr) × 100: entre hileras 35.1%; bajo la hilera 51.7%; cabecera 47.9%. 2. Entre hileras: Da 1.72 supera la Da crítica de frutales (1.7) y la porosidad es baja → compactación por tráfico de maquinaria. 3. Tráfico controlado (siempre por las mismas huellas), evitar entrar con suelo húmedo, cubierta vegetal entre hileras, y subsolado si la capa compactada limita raíces o infiltración.
:::

---

## Variabilidad espacial de la densidad aparente {.center .smaller}
...
## Efecto del manejo en la Da a largo plazo {.center .smaller}
...
::: {.notes}
1. Da = 148 / 98 = 1.51 g/cm³. 2. P = (1 − 1.51/2.65) × 100 = 43.0%. 3. θg = (172 − 148) / 148 = 0.162 g/g. 4. θv = 0.162 × 1.51 = 0.245 cm³/cm³. 5. Si la muestra se tomó a CC, entonces CC ≈ 0.245 y el suelo está en el límite superior de agua disponible: está bien regado y no necesita riego (agregar agua solo drenaría). Nótese que θv (0.245) < P (0.43): a CC hay aire en ~43% de los poros (0.185 cm³/cm³).
:::

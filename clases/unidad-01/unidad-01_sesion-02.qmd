...
::: {.notes}
Con los valores de la tabla anterior (suelo a CC): Suelo → Raíz: −0.04 → −0.2 = 0.16 MPa. Raíz → Xilema: −0.2 → −0.5 = 0.3 MPa. Xilema → Hoja: −0.5 → −1.0 = 0.5 MPa. Hoja → Atmósfera: −1.0 → −95 = 94 MPa. Caída total ≈ 95 MPa; el tramo hoja-atmósfera es ≈ 99% del total (la diapositiva dice ~98%, orden de magnitud correcto).
:::
...
![](../../images/analogia_ley_de_ohm.png){fig-align="center" width=100%}
...
::: {.notes}
1. Ln = (CC − θ) × Zr = (0.32 − 0.20) × 600 mm = 72 mm. 2. Lb = 72 / 0.90 = 80 mm. 3. ETc = 42 × 0.85 = 35.7 mm/semana (≈ 5.1 mm/día). 4. 72 / 5.1 ≈ 14 días para consumir esa lámina. Adelanto para U2: en la práctica se riega antes, al alcanzar el umbral de AFA, no cuando el suelo llega a 0.20.
:::

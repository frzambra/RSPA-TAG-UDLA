...
## Ejercicio rápido: ¿qué propiedad lo explica? {.center}

Nombra la propiedad del agua que explica cada fenómeno:

1. El suelo húmedo tarda más en calentarse que el seco → ______
2. La savia sube por el xilema de un árbol de 30 m → ______
3. Los nutrientes ($\text{NO}_3^-$, $\text{K}^+$) viajan disueltos hacia la raíz → ______
4. El agua asciende por poros finos contra la gravedad → ______

::: {style="font-size: 0.8em; text-align: center; margin-top: 1em;"}
Resuelve en 3 minutos. Discute con tu compañero.
:::

::: {.notes}
1. Calor específico alto (inercia térmica). 2. Cohesión + adhesión (tensión-cohesión). 3. Poder disolvente. 4. Capilaridad (tensión superficial).
:::
...
## Ejercicio: lee el balance hídrico de Chile {.center}

Con la tabla de zonas de Chile:

1. ¿En qué zona(s) llueve más de lo que evapora (superávit)?
2. ¿Cuál es el déficit ($P - ETo$) de la zona central? ¿Qué implica para el riego?
3. ¿Por qué el Norte Grande, con <1 mm/año de lluvia, igual tiene agricultura?
...
::: {.notes}
1. Zona Sur y Austral. 2. Déficit ≈ −1,000 mm/año → el riego es obligatorio todo el año. 3. Riego con aguas subterráneas y ríos andinos (acuíferos, embalses).
:::
...
## Ejercicio: ¿cuánta agua llega al cultivo? {.center}

Aplicas 1,000 m³ de agua con cada sistema. ¿Cuántos m³ quedan realmente disponibles para el cultivo?

| Sistema | Ea | Agua útil (m³) |
|---------|----|----------------|
| Inundación | 0.40 | ______ |
| Aspersión | 0.70 | ______ |
| Goteo | 0.90 | ______ |

::: {style="font-size: 0.8em; text-align: center; margin-top: 1em;"}
Resuelve en 3 minutos. ¿Qué sistema desperdicia menos?
:::

::: {.notes}
400, 700 y 900 m³ respectivamente. El goteo desperdicia solo ~10% del agua aplicada.
:::
...
## Ejercicio: piensa y discute {.center}

Chile exporta ~11,000 millones de m³ de agua virtual al año.

1. ¿Qué significa "exportar agua virtual"?
2. ¿Por qué es paradójico exportar palta desde Petorca, una zona con sequía?
3. ¿Qué criterios usarías para decidir si un cultivo es apropiado para una zona?

::: {style="font-size: 0.8em; text-align: center; margin-top: 1em;"}
Discute en parejas 4 minutos. Fundamenta con datos.
:::

::: {.notes}
La huella azul de la palta (~850 L/kg) se exporta como agua virtual. Clave: contrastar rentabilidad económica con sostenibilidad hídrica (HF azul vs. disponibilidad local).
:::
...
::: {.notes}
Producción = 12 ton/ha = 12.000 kg/ha. 1. Azul = 12.000 m³/ha ÷ 12.000 kg/ha = 1 m³/kg = 1.000 L/kg. 2. Verde = 180 mm = 1.800 m³/ha → 1.800.000 L ÷ 12.000 kg = 150 L/kg. 3. Gris = 300.000 L ÷ 12.000 kg = 25 L/kg → total = 1.000 + 150 + 25 = 1.175 L/kg. 4. Es ~56% del promedio global (2.080 L/kg), pero la composición cambia: aquí la huella azul es ~85% del total (vs ~41% en el promedio global). En Petorca casi toda el agua viene de pozo: el problema es la presión sobre el acuífero, no el volumen total.
:::
